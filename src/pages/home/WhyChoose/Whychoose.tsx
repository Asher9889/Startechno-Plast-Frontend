    ...
    <section className="bg-gradient-to-br from-black via-[#0a0a1a] to-purple-900 text-white px-6 md:px-16 py-16">
      <div className="max-w-6xl mx-auto">
        ...
        <h2 className="text-3xl md:text-4xl font-bold mb-8 text-center">
          About <span className="text-purple-400 underline">Star Technoplast</span>
        </h2>

        <div className="flex flex-col lg:flex-row gap-10 items-center">
          {/* About Text */}
          <p className="flex-[1.5] text-gray-300 leading-relaxed text-justify mb-12">
            <strong>Star Technoplast</strong> is a trusted name in the electrical and electronics accessories industry, recognized for delivering high-quality and innovative products that enhance everyday digital lifestyles. As a leading manufacturer and trader, we are committed to offering premium solutions that combine cutting-edge technology, durability, and modern design. <br />
            <br />

            Our expertise lies in crafting electrical and electronics accessories that not only meet global quality standards but also reflect the evolving needs of today’s tech-savvy customers. Whether it’s seamless connectivity, fast charging, or immersive sound, our products are designed to deliver unmatched performance.
              <br />
              <br />
            Every product undergoes strict quality checks to ensure performance, reliability, and long-term value. With an extensive catalog and a customer-first approach, we help brands and retailers scale faster by offering OEM/ODM services tailored to their business goals.
              <br />
          </p>

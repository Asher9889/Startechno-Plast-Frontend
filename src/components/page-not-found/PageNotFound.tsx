...
const PageNotFound = () => {
    return (
        <>
            <section className="relative h-screen w-screen bg-white dark:bg-gray-900">
                <img className="absolute w-full h-full" src={cms} alt="" />

                <div className="absolute py-8 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
